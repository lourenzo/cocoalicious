...
- (void) refreshAll {
	...
	DCAPICachePolicy policy = CocoaliciousCacheUseProtocolCachePolicy;
	
	if (([[NSApp currentEvent] modifierFlags] & (NSShiftKeyMask | NSAlphaShiftKeyMask)) != 0) {
		policy = CocoaliciousCacheReloadIgnoringCacheData;
	}
